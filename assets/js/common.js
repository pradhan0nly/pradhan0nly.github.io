$(document).ready(function () {
  ...
  // bootstrap-toc
  if ($("#toc-sidebar").length && typeof Toc !== 'undefined') {
  ...
  window.addEventListener('load', function () {
    ...
    // Fallback: If elements are still hidden after 2 seconds (e.g., observer failed), reveal them all
    setTimeout(() => {
      sectionsToReveal.forEach(el => el.classList.add('reveal-active'));
    }, 2000);
  });
});
